...
public class TodayWeatherFragment extends Fragment {
    ...
    TextView txt_city_name, txt_description, txt_date_time, txt_temperature, txt_wind, txt_pressure, txt_humidity, txt_sunrise, txt_sunset, txt_geo_coord;
    ...
    private void getWeatherInformation() {
        compositeDisposable.add(mService.getWeatherByLatLng(String.valueOf(OpenWeather.current_location.getLatitude()),
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_temperature.setText(new StringBuilder(String.valueOf(weatherResult.getMain().getTemp()))
                                .append("°C").toString());
                        txt_date_time.setText(OpenWeather.convertUnixToDate(weatherResult.getDt()));
                        ...
                        txt_humidity.setText(new StringBuilder(String.valueOf(weatherResult.getMain().getHumidity()))
                                .append(" %").toString());
                        txt_sunrise.setText(OpenWeather.convertUnixToHour(weatherResult.getSys().getSunrise()));
                        txt_sunset.setText(OpenWeather.convertUnixToHour(weatherResult.getSys().getSunset()));
